...
<div id="jobpost" class="container">
	...
	<!-- Emd SideBar -->
        ...
        <div id="content" class="content span-19 last floatLeft">
                ...
                <form  action="<?=site_url('employer/post_job/');?>" method="POST">

                        <!-- Begin Step 1- Panel -->
                        <div class="panelContainer last">
                                <h2 class="panelHeader"><span><?=$this->lang->line('Company Information')?></span></h2>
									...
									<div class="panelContent">
                                        <fieldset>
                                                ...
                                                <dl class="formRow span-18">
                                                        <dt>
                                                            <label for="companydesc">
														  <?=$this->lang->line('Size')?><span class="note">(<?=$this->lang->line('Optional')?>)</span></label>
                                                        </dt>
                                                        <dd class="formValue span-13">
                              ...
                              <?php } }?>
                                                ...
                                                <dl class="formRow span-18">
                                                        <dt>
                                                                <label for="companydesc"><?=$this->lang->line('Company website')?><span class="note">(<?=$this->lang->line('Optional')?>)</span></label>
                                                        </dt>
                                                        <dd class="formValue span-13">
                                                ...
                                                <dl class="formRow span-18">
                                                        <dt>
                                                                <label for="companydesc">
																<?=$this->lang->line('Company address')?><span class="note">(<?=$this->lang->line('Optional')?>)</span></label>
                                                        </dt>
                                                        <dd class=" formValue span-13">
                                                ...
                                                <dl class="formRow span-18" id="errorcompanyprofile">
                                                        ...
                                                        <dd class="formValue span-13">
                                                                <textarea type="text" class="bottom" onkeyup="limiter(this.id,'companyprofileremain',2,10000)" name="companyprofile" id="companyprofile" rows="8" tabindex="5"><?=$this->EM->nl2br_revert(@$em_info->em_com_profile);?></textarea>
                                                                <br>
                                                                <span class="note" id="companyprofileremain"><?=$this->lang->line('You have 9660 characters remaining')?></span> <span class="errorMessage" id="err_companyprofile" style="display:none"><strong class="sprite_icon warningIcon">Please enter company profile</strong></span>
               ...
               <option value="<?=set_value('joblevelid');?>" selected=""><?=$this->lang->line('Please select')?></option>
               <?php foreach($em_level as $row) { ?>
                <option value="<?=$row->id;?>" <?=set_select('joblevelid',$row->id)?>><?=$row->em_level;?></option>
                <?php } ?>
            </select>
                 ...
                 <?php foreach($em_type as $row){?>
                  <option value="<?=$row->id;?>" <?=set_select('typeworkingid',$row->id)?>><?=$row->em_job_name;?></option>
                  <?php } ?> </select>
                       ...
                       <?php foreach($em_salary as $row){?>
                        ...
                        <?php } ?>
                                                                        ...
                                                                        <span id="salaryrange">
	                                                                        ...
	                                                                        <br><span class="inlineText span-1minus" style="clear: both"><?=$this->lang->line('Min')?> </span><input type="text" class="text span-2 " name="salarymin" id="salarymin"  tabindex="12">
	                                                                       <span class=" inlineText span-1minus padding-left"><?=$this->lang->line('Max')?> </span><input type="text" class="text span-2" name="salarymax" id="salarymax"  tabindex="13">
                                                    ...
                                                    <dt>
                                                                ...
                                                                <dd class="formValue span-12 relative">   
                                                                    ...
                                                                    <!-- dunglt modify -->
     																<select name="work_place" class="select span-7 required" tabindex="9">
                                                                    	...
                                                                    	<option value="<?=$row->id;?>" <?=set_select('work_place',$row->id)?>><?=$row->em_city;?></option>
                                                                        <?php } ?>
                                                                    </select> 
                                                        ...
                                                        <dl class="formRow span-18" id="errorindustry">
                                                                ...
                                                                <dd class="formValue span-12 relative">
                                                                    	...
                                                                    	<option value="<?=$row->id;?>"<?=set_select('job_category',$row->id)?>><?=$row->em_cat_name;?></option>
                                                                        <?php } ?>
                                                           </select> 
														...
														<dl class="formRow span-18">
                                                                ...
                                                                <dd class="formValue span-13">
                                                                    ...
                                                                    <input type="text" tabindex="7" onfocus="formatText(this,'dd/mm/yyyy');" onblur="setDefaultValue(this,'dd/mm/yyyy')" value="<?=set_value('txtBirthday');?>" class="text span-5plus hintText" name="txtBirthday" id="txtBirthday" style="width:200px;">
                                                                     <span class="errorMessage" id="err_email_jobrequirement" style=""><strong class="sprite_icon warningIcon"><?=form_error('txtBirthday')?></strong></span>
                                                        </dd></dl>
...
<dl class="formRow span-18" id="erroremailaddress">
		...
		<!-- End Step 3-->
                        ...
                        <div class="formAction">
                                        <fieldset>
											<input type="submit" name="btnJob" value="<?=$this->lang->line('Continue')?>" class="btn_em">
											<input type="submit" class="btn_em" value="<?=$this->lang->line('Save for later')?>">
