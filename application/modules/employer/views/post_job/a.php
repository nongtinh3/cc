...
<div id="jobpost" class="container">
                ...
                <?php } ?>
                 ...
                 <?php foreach($em_type as $row){?>
                  ...
                  <?php } ?> </select>
                       ...
                       <option value="<?=set_value('salaryrangeid');?>" selected="">Specified</option>
  ...
  <li>
<input type="checkbox"
 onclick="addCart('<?=$row->id;?>','<?=$row->em_city;?>',$('#city_<?=$row->id;?>'))" 
 id="city_<?=$row->id;?>" value="<?=$row->id;?>" tabindex="14" name="cityid[]">
 <label id="textcity_<?=$row->id;?>" 
 onclick="
 if($('#city_<?=$row->id;?>').is(':checked')){$('#city_<?=$row->id;?>').attr('checked',false)
 }
 else{
 $('#city_<?=$row->id;?>').attr('checked',true)} 
 addCart('<?=$row->id;?>','<?=$row->em_city;?>',$('#city_<?=$row->id;?>'))" 
 class="pointer"><?=$row->em_city;?></label>
 </li>                                                                     
 <?php  } ?>
 ...
 <?php  } ?>
                                                        ...
                                                        <dl class="formRow span-18" id="errorjobdescription">
                                                                ...
                                                                <dd class="formValue span-12plus">
                                                                        ...
                                                                        <span class="note" id="jobdescriptionremain">You have 14500 characters remaining</span><span class="errorMessage" id="err_jobdescription" ><strong class="sprite_icon warningIcon"><?=form_error('jobdescription');?></strong>
                                                                        </span>
														...
														<dl class="formRow span-18" id="errorjobrequirement">
                                                                ...
                                                                <dd class="formValue listtype_on span-13">
                                                                        <textarea title="Please enter job requirement" type="text" class="bottom required" onkeyup="limiter(this.id,'skillexperienceremain',2,14500)" name="job_requirement" id="jon_requirement" rows="10" tabindex="17"></textarea>
                                                                         <span class="note" id="skillexperienceremain">You have 14500 characters remaining</span><span class="errorMessage" id="err_skillexperience" ><strong class="sprite_icon warningIcon"><?=form_error('job_requirement');?></strong></span>
