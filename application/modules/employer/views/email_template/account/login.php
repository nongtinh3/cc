...
<div class="loginPic">
            ...
            <div class="loginBox">
            <span style="margin-left:170px"><a href="#"><img width="80" height="40" border="0" src="http://images.vietnamworks.com/spacer.gif" alt=""></a></span> <br><br>
            	                <br>
                ...
                <form action="<?=site_url('employer/login');?>" method="post" name="fr" onsubmit="return kt();">
                    ...
                    <a href="#" class="float_left">Did you forget your password?</a>
                   </div>
                <div class="loginBtn">
